def pattern():
    for i in range(len(name)):
        ...
        if name[i]=="A":
            ...
            for row in range(7):
                for col in range(6):
                    if ((col==0 or col==5) and (row!=0 and row!=4)) or ((row==0 or row==3) and (col>0 and col<4)):
                        print_A[row][col] = "*"
        ...
        #Q
            ...
            print_Q = [[" " for i in range(8)] for j in range(5)]
            for row in range(8):
                for col in range(5):
        ...
        #R
            ...
            for row in range(7):
                for col in range(5):
                    if (col == 0) or ((col == 4) and (row != 0 and row != 3)) or (
                            (row == 0 or row == 3) and (col > 0 and col < 4)):
                        print_R[row][col]="*"
        ...
        #V
            ...
            print_V = [[" " for i in range(4)] for j in range(7)]
            for row in range(7):
                for col in range(4):
        ...
        #Y
            ...
            for row in range(7):
                for col in range(6):
                    if (col == 2 and row > 1) or ((row == col) and (col < 2)) or (row == 0 and col == 4) or (
                            row == 1 and col == 3):
                        print_Y[row][col]="*"
        ...
        #Z
            ...
            for row in range(7):
                for col in range(6):
                    if (row == 0) or (row == 4) or (row == 1 and col == 3) or (row == 2 and col == 2) or (
                            row == 3 and col == 1):
                        print_Z[row][col]="*"
